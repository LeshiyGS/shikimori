...
public class Activity_Animes extends ShikiSherlockFragmentActivity {
	...
	static String fduration = "";
	static String frating = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        Adapter_Animes viewpageradapter = new Adapter_Animes(fm);
        ...
        if ((savedInstanceState != null)) {
			...
			t_fduration = savedInstanceState.getString("t_fduration");
			t_frating = savedInstanceState.getString("t_frating");
		...
		getSupportMenuInflater().inflate(R.menu.search_item, menu);
			...
			searchView.setOnQueryTextListener(new OnQueryTextListener() {
		        ...
		        public boolean onQueryTextSubmit(String query) {
		    		...
		    		if (Fragment_Animes.al.getStatus() == AsyncTask.Status.RUNNING){
    ...
    protected void onResume() {
  	...
  	public void onSaveInstanceState(Bundle outState) {
 		...
 		outState.putString("t_fstatus", t_fstatus);
  		...
  		outState.putString("t_fduration",t_fduration);
  		outState.putString("t_frating",t_frating);
