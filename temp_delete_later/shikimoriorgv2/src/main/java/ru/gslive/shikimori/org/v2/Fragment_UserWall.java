...
public class Fragment_UserWall extends SherlockFragment {
	...
	public static AsyncTask<Void, Void, Void> al_clear;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //Основное окно
	    ...
	    al_clear = new AsyncClearLoading();
	...
	public boolean onContextItemSelected(MenuItem item) {
	    ...
	    Intent intent = Functions.choiseContextItem(item, result.get(info.position-1), "user_page",
	    		Activity_UserProfile.target_id, getActivity().getBaseContext(), lv_main);
	    if (intent != null){
    ...
    //Асинхронная задача подгрузки новостей
  	private class AsyncLoading extends AsyncTask<Void, Void, Void> {
  		...
  		protected Void doInBackground(Void... arg0) {
  			try {
				t_result = SSDK_API.getComments_new(Activity_UserProfile.target_id, "User", 20, page_no, Functions.preference.kawai);
				t_comments_sname.clear();
  	...
  	//Асинхронная задача новой
  	private class AsyncClearLoading extends AsyncTask<Void, Void, Void> {
