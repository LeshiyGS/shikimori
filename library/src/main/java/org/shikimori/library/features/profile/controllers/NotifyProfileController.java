package org.shikimori.library.features.profile.controllers;
...
import org.shikimori.library.features.profile.UserHistoryFragment;
...
public class NotifyProfileController implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (item.id == NEWS) {
            ...
            mContext.loadPage(InboxFragment2.newInstance());
