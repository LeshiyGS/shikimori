 ...
 */
public abstract class BaseUserListAdapter<T> extends SimpleBaseAdapter<T, BaseUserListAdapter.ViewHolder> {

    public BaseUserListAdapter(Context context, List<T> list) {
