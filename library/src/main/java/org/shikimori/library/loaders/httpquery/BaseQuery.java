...
//    // type return content
//    MyStatusResult.TYPE type = MyStatusResult.TYPE.OBJECT;
//    // request method
...
//        // type return content
//        this.type = MyStatusResult.TYPE.OBJECT;
//        if(client!=null)
...
//     * @return
//     */
//    public T init(String prefix, MyStatusResult.TYPE type) {
//        init(prefix);
//        this.type = type;
//        return (T) this;
//    }
...
//                MyStatusResult res = new MyStatusResult(data, type);
//                res.setSuccess();
...
//            MyStatusResult res = new MyStatusResult();
...
//    }
//
//    public abstract boolean fail(MyStatusResult stat, String data);
//
//    void failResult(byte[] bytes) {
//        MyStatusResult stat = new MyStatusResult();
...
//
//    boolean showError(MyStatusResult res) {
//        if (context == null)
//            return true;
//        if (!res.isSuccess()) {
//            hideLoaders();
...
//     * @param res
//     */
//    public void showStandartError(MyStatusResult res) {
//        if (context == null)
//            return;
...
//        public MyStatusResult.TYPE type;
...
//
//            MyStatusResult res = new MyStatusResult(data, reqData.type);
//
