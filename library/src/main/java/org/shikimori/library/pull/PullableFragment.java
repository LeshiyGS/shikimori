 ...
 */
public abstract class PullableFragment<T extends AppCompatActivity> extends BaseFragment<T> implements SwipeRefreshLayout.OnRefreshListener, QueryShiki.OnQueryErrorListener<ShikiStatusResult> {
