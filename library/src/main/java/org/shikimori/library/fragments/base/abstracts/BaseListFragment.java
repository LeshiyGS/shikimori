 ...
 */
public abstract class BaseListFragment<T extends AppCompatActivity> extends PullableFragment<T> implements QueryShiki.OnQuerySuccessListener<ShikiStatusResult>,
